...
import { Person, createPerson, createPeople, findByName, findByFood, findById, findEdit, update, removeOne, removeMany, chain } from "./myApp.js";
...
router.get("/file/*?", function (req, res, next) {
  ...
  fs.readFile(path.join(import.meta.dirname, req.params[0]), function (err, data) {
    if (err) {
      return next(err);
    }
